...
#Load Data
train_df = tiingo.load_data_by_date(symbol, "2022-10-15", "2022-12-31", dataProcessor,resolution)
...
#Train
agTrain = RayTune(tracer,logDirectory=logDir,name=trainName,algorithm="DQN")
